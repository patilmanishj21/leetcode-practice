'''
In the world of Dota2, 
there are two parties: the Radiant and the Dire.
...
Announce the victory: If this senator found 
the senators who still have rights to vote are all 
...
And in round 2, the first senator can 
...
And in round 2, the third senator can just announce 
...
def predictPartyVictory(senate: str) -> str:
    ...
    while radiant and dire:
        r = radiant.popleft()
        d = dire.popleft()
        if r < d:  # Radiant senator acts first
            radiant.append(r + n)
